        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={6} sm={4}>
            <FormControl fullWidth>
              ...
              >
                <MenuItem value="DairyandBakery">Dairy and Bakery</MenuItem>
                <MenuItem value="Freshproduce">Fresh Produce</MenuItem>
          ...
          <Grid item xs={6} sm={4}>
            <FormControl fullWidth>
              ...
              >
                <MenuItem value="dairyBakery">Dairy and Bakery</MenuItem>
          ...
          <Grid item xs={6} sm={4}>
            <FormControl fullWidth>
              ...
              >
                <MenuItem value="MilkCheeseandYogurt">Milk, Cheese, and Yogurt</MenuItem>
                <MenuItem value="bread">Bread</MenuItem>
                <MenuItem value="PastriesandCakes">Pastries and Cakes</MenuItem>
                <MenuItem value="Fruits">Fruits</MenuItem>
                <MenuItem value="Vegetables">Vegetables</MenuItem>
                <MenuItem value="SST">Shampoo, Soap, and Toothpaste</MenuItem>
